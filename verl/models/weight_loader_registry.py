...
def get_weight_saver(arch: str):
    from verl.models.mcore.saver import merge_megatron_ckpt_gptmodel, merge_megatron_ckpt_gptmodel_dpskv3, merge_megatron_ckpt_gptmodel_mixtral, merge_megatron_ckpt_gptmodel_qwen2_5_vl, merge_megatron_ckpt_gptmodel_qwen_moe, merge_megatron_ckpt_gptmodel_bailing_moe
    ...
    _MODEL_WEIGHT_MEGATRON_SAVER_REGISTRY = {
        ...
        "BailingMoeForCausalLM": merge_megatron_ckpt_gptmodel_bailing_moe,
    }
